...
//     const { id } = useParams();
//     const booking = useSelector(state => state.customer.bookings.find(ele => ele._id === id));
...
//     return (
//         <Container>
//             <h2 className="text-center mt-4">Review for parkingSpace: {booking.parkingSpaceId?.title}</h2>
